 ...
 */
this.PIXI = this.PIXI || {};
var _pixi_loaders = (function (exports, ResourceLoader, utils, blob, core) {
    'use strict';

    var ResourceLoader__default = 'default' in ResourceLoader ? ResourceLoader['default'] : ResourceLoader;
    ...
    Loader.registerPlugin({ use: blob.blobMiddlewareFactory() });
...
}({}, ResourceLoader, PIXI.utils, blob, PIXI));
