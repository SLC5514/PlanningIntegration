<?php /* Smarty version 3.1.27, created on 2020-06-05 10:30:31
         compiled from "/data/htdocs/pop136_yuntu/views/similar/similar-list.html" */ ?>
<?php
/*%%SmartyHeaderCode:514877005ed9ae4794d929_14875768%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b546bc225cca8e00366c5b1cb564f97c6f68919b' => 
    array (
      0 => '/data/htdocs/pop136_yuntu/views/similar/similar-list.html',
      1 => 1587877444,
      2 => 'file',
    ),
    ...
    'd538a07749b2d6744fac0fce2a2aa844fdb94f6f' => 
    array (
      0 => 'd538a07749b2d6744fac0fce2a2aa844fdb94f6f',
      1 => 0,
      2 => 'string',
    ),
    ...
    '90eb89247d56146ef01dacb4355e8a63ecfa0542' => 
    array (
      0 => '90eb89247d56146ef01dacb4355e8a63ecfa0542',
      1 => 0,
      2 => 'string',
    ),
    ...
    'd457fdc7951ceaf5753e0f32feadcc9805c5278a' => 
    array (
      0 => 'd457fdc7951ceaf5753e0f32feadcc9805c5278a',
      1 => 0,
      2 => 'string',
    ),
    '99b8dfec3003c712348e11f2edbfdc23cdc16786' => 
    array (
      0 => '99b8dfec3003c712348e11f2edbfdc23cdc16786',
      1 => 0,
      2 => 'string',
    ),
  ),
  'nocache_hash' => '514877005ed9ae4794d929_14875768',
  'variables' => 
  array (
    'TDK_title' => 0,
    'TDK_keywords' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5ed9ae47acbd13_22954646',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5ed9ae47acbd13_22954646')) {
function content_5ed9ae47acbd13_22954646 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '514877005ed9ae4794d929_14875768';
?>
<!DOCTYPE html>
<html>
    <head>
...
<link rel="stylesheet" type="text/css" href="<?php echo @constant('STATIC_URL1');?>
/global/css/similar/similar-list.css?<?php echo @constant('STATIC_CHANGE_TIME');?>
" /> 
...
echo $_smarty_tpl->getInlineSubTemplate("header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, '5202727355ed9ae47a05871_21854298', 'content_5ed9ae47a04ed4_45291459');
...
<div class="content">
	<div class="section fabric-content">
		
		<div class="similar-load js-similar-load">
			<div class="similar-calculation">
				<div class="pic-show">
					<div class="pic-contain js-pic-contain"><img src="" alt=""></div>
				</div>
				<div class="load-state">
					<h2><span class="icon"></span>上传至<span class="load-h">“云服务”</span>进行计算</h2>
					
					<div class="load-list js-load-list">
						<ul>
							<li>正在识别图案颜色...</li>
							<li>正在识别图案花纹...</li>
							<li>正在识别图案类型...</li>
					...
					<div class="load-progress js-load-progress"><p></p></div>
				</div>
			</div>

		</div>
		
		<div class="similar-suc js-similar-suc">
			<div class="fabric-msg clear">
				...
				<div class="fabric-right">
					<div class="fabrg-msg">
						<div class="fabrg-border"></div>
						<div class="fabrg-top clear">
							<div class="fabrgt-l">
								<h2>在本站图案素材中找到以下内容</h2>
								<p class="color-d">如果找不到合适的图案素材，你可以调整截取区域或者换张图试试~</p>
								<div class="color-d">搜索共耗时  <span class="js-end-t">0</span> 秒</div>
								<!-- 20次权限显示 -->
								<span class="js-remaining-times">剩余<span>0</span>次体验</span>
							</div>
							<div class="fabrgt-r">
								<a class="yun-virtual js-yun-virtual" href="javascript:void(0);" title="模拟成品"><span class="icon"></span>模拟成品</a>
								<a class="go-back js-return-back-btn" href="javascript:void(0);" title="返回">返  回</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="fabric-similar">
				<div class="similar-t clear">
					<h3>相似图案素材</h3>
					<p class="color-d"><span class="icon"></span>在列表中排序越靠前的图案，系统判断与您的需求相似度越高</p>
				</div>
				<div class="search-content search-content2 js-search-content clear">
					<ul class="clear js-word-sec"></ul>
					
					<div class="words-close words-close2 js-words-close">
						<span class="close-s close-s1">收起</span>
						<span class="close-s close-s2">更多</span>
				...
				<div class="fabric-contain js-fabric-contain">
					<!--图搜图列表-->
					<div class="fabric-list">
						<ul class="clear js-fabric-list"></ul>
					</div>
...
echo $_smarty_tpl->getInlineSubTemplate("footer.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, '7367063755ed9ae47a67f81_79548865', 'content_5ed9ae47a67842_63627189');
...
/global/js/similar/similar-list.js?<?php echo @constant('STATIC_CHANGE_TIME');?>
...
?><?php
/*%%SmartyHeaderCode:5202727355ed9ae47a05871_21854298%%*/
if ($_valid && !is_callable('content_5ed9ae47a04ed4_45291459')) {
function content_5ed9ae47a04ed4_45291459 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->properties['nocache_hash'] = '5202727355ed9ae47a05871_21854298';
?>
<!-- header start -->
<?php echo '<script'; ?>
 type="text/javascript">
...
<?php }?>
<!-- header end --><?php
/*/%%SmartyNocache:5202727355ed9ae47a05871_21854298%%*/
}
}
?><?php
/*%%SmartyHeaderCode:7367063755ed9ae47a67f81_79548865%%*/
if ($_valid && !is_callable('content_5ed9ae47a67842_63627189')) {
function content_5ed9ae47a67842_63627189 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->properties['nocache_hash'] = '7367063755ed9ae47a67f81_79548865';
?>
<!-- footer start -->
<div class="footer">
...
<!-- footer end --><?php
/*/%%SmartyNocache:7367063755ed9ae47a67f81_79548865%%*/
}
}
?>