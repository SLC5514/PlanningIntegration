 ...
 */
this.PIXI = this.PIXI || {};
var _pixi_core = (function (exports, runner, utils, settings, constants, ticker, math, display) {
    'use strict';
    ...
    Framebuffer.prototype.addDepthTexture = function addDepthTexture (texture)
    {
        ...
        this.depthTexture = texture || new BaseTexture(new DepthResource(null, { width: this.width, height: this.height }), { scaleMode: 0,
            ...
            type: constants.TYPES.UNSIGNED_SHORT });// UNSIGNED_SHORT;
        /* eslint-disable max-len */
        this.dirtyId++;
        this.dirtyFormat++;
    ...
    var BatchRenderer = /*@__PURE__*/(function (ObjectRenderer) {
        ...
        BatchRenderer.prototype.flush = function flush ()
        {
            ...
            for (i = 0; i < this.currentIndex; ++i)
            {
                ...
                var spriteBlendMode = utils.premultiplyBlendMode[nextTexture.premultiplyAlpha ? 1 : 0][sprite.blendMode];
        ...
        BatchRenderer.prototype.packGeometry = function packGeometry (element, float32View, uint32View, indexBuffer, index, indexCount)
        {
            ...
            var argb = alpha < 1.0 && element._texture.baseTexture.premultiplyAlpha ? utils.premultiplyTint(element._tintRGB, alpha)
