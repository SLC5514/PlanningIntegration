$(function(){	
	...
	$('.js-cont-msg a').hover(function(){
		...
		img_link='url('+def.img_path+'20180704/images/'+_src+')';
		bg_link='url('+def.img_path+'20180704/images/'+_bgsrc+')';
		$(".js-top-cont").css({
	...
	function hvBack(){
		...
		back_timer=setTimeout(function(){
			var d_w = $('.js-season-contain').width();
			var img_link1='url('+def.img_path+'20180704/images/t-bg1.jpg)';
			var bg_link1='url('+def.img_path+'20180704/images/top-tit.png)';			
