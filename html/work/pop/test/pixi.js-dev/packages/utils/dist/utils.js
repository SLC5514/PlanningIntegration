...
var _pixi_utils = (function (exports, settings, eventemitter3, earcut, _url, constants) {
    'use strict';

    eventemitter3 = eventemitter3 && eventemitter3.hasOwnProperty('default') ? eventemitter3['default'] : eventemitter3;
    earcut = earcut && earcut.hasOwnProperty('default') ? earcut['default'] : earcut;
    _url = _url && _url.hasOwnProperty('default') ? _url['default'] : _url;
...
}({}, PIXI, eventemitter3, earcut, _url, PIXI));
