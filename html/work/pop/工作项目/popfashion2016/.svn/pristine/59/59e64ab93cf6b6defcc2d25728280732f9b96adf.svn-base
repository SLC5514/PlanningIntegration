...
window.tagcloud = (function(win, doc) { // ns
    ...
    function TagCloud (options) {
        ...
        self.box.style.minHeight = 2.5 * self.size + "px";
        self.box.style.minWidth = 6 * self.size + "px";
        for (var j = 0, len = self.items.length; j < len; j++) {
    ...
    TagCloud.prototype = {
        ...
        update: function () {
            ...
            for (var j = 0, len = self.items.length; j < len; j++) {
                ...
                self.items[j].element.style.left = self.items[j].x*7 + (self.box.offsetWidth - self.items[j].offsetWidth) / 2 + "px";
        ...
        _getItems: function () {
            ...
            for (var i = 0; i < length; i++) {
                ...
                item.element.style.left = item.x*5 + (self.box.offsetWidth - item.offsetWidth) / 2 + "px";
