...
(function(g){
    //获取对象
    var series_box=document.querySelector(".js-color-series-div");
    var detail_box=document.querySelector(".js-detail-color-div");
    ...
    // 局部对象
    var nw=parseInt(getStyle(detail_box,"width")) || detail_box.offsetWidth;
    // console.log(nw);
    var def={
        is_show_color:false,
        is_drag_start:false,
