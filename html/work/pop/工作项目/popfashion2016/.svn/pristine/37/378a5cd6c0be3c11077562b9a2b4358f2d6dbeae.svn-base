...
(function() {
    ...
    function b(q, G, t) {
        ...
        i(w, {
            ...
            _api: function() {
                if (!w.isLoaded()) {
                    throw " " + w.id() + " not loaded when calling an API method"
                }
                return v
            },
            setClip: function(H) {
    ...
    var g = i(window.flashembed, {
        ...
        getHTML: function(o, l) {
            ...
            if (l) {
				...
				//config={"clip":{"autoPlay":false,"autoBuffering":true,"url":"/009/2013/20130716/event/30491/20130716110943_89016.flv"},"plugins":{"controls":{"url":"flowplayer.controls-3.2.4-dev.swf"}},"playerId":"player","playlist":[{"autoPlay":false,"autoBuffering":true,"url":"/009/2013/20130716/event/30491/20130716110943_89016.flv"}]}
				/*n += '<param name="flashvars" value=\'' + 'config={"clip":{"autoPlay":false,"autoBuffering":true,"url":"a.php?pop=1"},"plugins":{"controls":{"url":"flowplayer.controls-3.2.4-dev.swf"}},"playerId":"player","playlist":[{"autoPlay":false,"autoBuffering":true,"url":"a.php?pop=1"}]}' + "' />"*/
            }
            n += "</object>";
            return n
        },
