<?php /* Smarty version 3.1.27, created on 2020-06-16 16:45:36
         compiled from "/data/htdocs/popfashion2016/views/cutpicloading.html" */ ?>
<?php
/*%%SmartyHeaderCode:6189358355ee886b0458a71_47022446%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bde8a2efcde414e36571cb172cc176b8cb7039ef' => 
    array (
      0 => '/data/htdocs/popfashion2016/views/cutpicloading.html',
      1 => 1592285182,
      2 => 'file',
    ),
    ...
    '31c9ae4d2a3b5ddc91bbf8f56f32c7bbdc78a058' => 
    array (
      0 => '31c9ae4d2a3b5ddc91bbf8f56f32c7bbdc78a058',
      1 => 0,
      2 => 'string',
    ),
    'cab7e9e53c5f25fcc3f78afc7731ee7887e37519' => 
    array (
      0 => 'cab7e9e53c5f25fcc3f78afc7731ee7887e37519',
      1 => 0,
      2 => 'string',
    ),
    'af8dd8ae456f5fcf23e90479a2844a2d16d566fc' => 
    array (
      0 => 'af8dd8ae456f5fcf23e90479a2844a2d16d566fc',
      1 => 0,
      2 => 'string',
    ),
    '0981f0333f0879f9fccb7fcb337d3504a0d1f317' => 
    array (
      0 => '0981f0333f0879f9fccb7fcb337d3504a0d1f317',
      1 => 0,
      2 => 'string',
    ),
    ...
    '845f2ae45b199768e95ec2119818f8c7aef864a9' => 
    array (
      0 => '845f2ae45b199768e95ec2119818f8c7aef864a9',
      1 => 0,
      2 => 'string',
    ),
    '4aa1fc07264e110aae25f0fc702d826ecdcdb738' => 
    array (
      0 => '4aa1fc07264e110aae25f0fc702d826ecdcdb738',
      1 => 0,
      2 => 'string',
    ),
    ...
    '155e7db278b55141bb110669160628bb0ca4abfe' => 
    array (
      0 => '155e7db278b55141bb110669160628bb0ca4abfe',
      1 => 0,
      2 => 'string',
    ),
  ...
  'nocache_hash' => '6189358355ee886b0458a71_47022446',
  'variables' => 
  array (
    'header_token' => 0,
    'title' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5ee886b0a16c98_31886319',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5ee886b0a16c98_31886319')) {
function content_5ee886b0a16c98_31886319 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '6189358355ee886b0458a71_47022446';
?>
<!DOCTYPE html>
<html>
<head>
...
$_smarty_tpl->properties['nocache_hash'] = '6189358355ee886b0458a71_47022446';
?>
以图搜图搜索结果-POP服装趋势网</title>
	<meta name="keywords" content="<?php
$_smarty_tpl->properties['nocache_hash'] = '6189358355ee886b0458a71_47022446';
?>
POP识图,以图搜图,图像检索,图像识别,图片识别,图片搜索,图像搜索,识图,搜图,找图,找款,服装款式图片"/>
	<meta name="description" content="<?php
$_smarty_tpl->properties['nocache_hash'] = '6189358355ee886b0458a71_47022446';
?>
POP服装趋势网以图搜图、图像搜索系统，拥有时尚行业领先的智能图像识别技术，上传对应服饰行业图片，为你搜寻类似服饰图款，快速找款，省时省力。"/>
...
echo $_smarty_tpl->getInlineSubTemplate("common/search_head.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, '1409169925ee886b07d4b71_24665891', 'content_5ee886b07cdce3_32060870');
...
/global/images/new_common/nav_logo.png" alt="POP服装趋势"><i class="common-icon"></i></a>
		...
		<?php if (!$_smarty_tpl->tpl_vars['canUse']->value) {?>
		...
		<?php } else { ?>
			<?php if ($_smarty_tpl->tpl_vars['trialInfo']->value) {?>
			<div class="free-times">
				<div class="times-txt">
					当前账号为普通用户，拥有<span>20</span>次免费体验机会，还剩余<span><?php echo $_smarty_tpl->tpl_vars['trialInfo']->value['free'];?>
</span>次机会
				</div>
			</div>
			<?php }?>
					...
					<div class="screen-btn js-screen-btn">
						...
						<div class="screen-list">
							...
							<div class="screen-item clearfix">
								<div class="item-left js-sCategory-head"><a>款式</a></div>
								<div class="item-right js-sCategory">
									<!-- <span><a data-id="<?php echo $_smarty_tpl->tpl_vars['val']->value['id'];?>
...
/global/images/styles_page/loading.gif?<?php echo STATIC_CHANGE_TIME;?>
"/>
					</div>
				</div>
			</div>
			...
			<div class="no-data js-no-data" style="display: none;">
				<div class="no-data-box">
					<img src="<?php echo STATIC_URL2;?>
/global/images/common/search-result.png?<?php echo STATIC_CHANGE_TIME;?>
"/>
			...
			<!-- 图片大小错误 -->
			<div class="err-img-size js-err-img-size" style="display: none;">
				<div class="ctn">
					<img src="<?php echo STATIC_URL2;?>
/global/images/common/search-result.png?<?php echo STATIC_CHANGE_TIME;?>
"/>
					<div class="title">抱歉！图片尺寸超出限制，请重新上传图片。</div>
					<div class="info-btn">为什么会超出限制？<div class="info">图片需要经过base64编码才能检索，不同编码的图片大小会有差别，因此可能会造成编码后图片尺寸超过限制（图片小于4M，最长边不大于4096px）</div></div>
					<div class="btn">上传图片</div>
				</div>
			</div>
			<!-- 网络错误 -->
			<div class="err-img-internet js-err-img-internet" style="display: none;">
				<div class="ctn">
					<img src="<?php echo STATIC_URL2;?>
/global/images/common/search-result.png?<?php echo STATIC_CHANGE_TIME;?>
"/>
					<div class="title">抱歉，出了点问题，检索失败！</div>
					<div class="info">可能的原因有：</div>
					<ul>
						<li>网络请求超时，您可以 <span class="reload">刷新重试</span></li>
						<li>其他未知问题，您可以 <span class="upimg">上传新图片</span></li>
					</ul>
				</div>
			</div>
			<!-- 切图层 -->
...
echo $_smarty_tpl->getInlineSubTemplate("footer.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, '1240464745ee886b087c018_22118306', 'content_5ee886b0877c50_19823091');
...
$(function(){
			...
			success: function(data) {
				if (data.code == 200) {
					...
					for(var item in list){
						if(item!='total_num'){
							html+='<a href="'+list[item].detail_link+'" target="_blank" class="item">'+
					...
					$('.js-err-img-size').show();
					$('.js-screen-btn').hide();
					$('.js-screen').hide();
					$('.js-firework').hide();
				} else if (data.code == 1002) {
					$('.js-err-img-internet').show();
					$('.js-screen-btn').hide();
					$('.js-screen').hide();
					$('.js-firework').hide();
				} else{
	...
	/* 错误页 */
	$('.js-err-img-size').on('click', '.info-btn', function() {
		$(this).children('.info').show();
	}).on('click', '.btn', function() {
		$('.js-err-img-size').hide();
		$('.js-screen-btn').show();
		$('.js-screen').show();
		$('.js-firework').show();
        $("#uploadImg").trigger("click");
	})
	$('.js-err-img-internet').on('click', '.reload', function() {
		window.location.reload();
	}).on('click', '.upimg', function() {
		$('.js-err-img-internet').hide();
		$('.js-screen-btn').show();
		$('.js-screen').show();
		$('.js-firework').show();
        $("#uploadImg").trigger("click");
...
echo $_smarty_tpl->getInlineSubTemplate("common/common_script.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, '9829143865ee886b09ece70_93459984', 'content_5ee886b09e8fe2_75777248');
...
?><?php
/*%%SmartyHeaderCode:15372613595ee886b05e9c41_78158881%%*/
if ($_valid && !is_callable('content_5ee886b05e69d9_63034355')) {
function content_5ee886b05e69d9_63034355 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->properties['nocache_hash'] = '15372613595ee886b05e9c41_78158881';
?>
<!-- 导航改版 -->
...
<?php
/*/%%SmartyNocache:15372613595ee886b05e9c41_78158881%%*/
}
}
?><?php
/*%%SmartyHeaderCode:1409169925ee886b07d4b71_24665891%%*/
if ($_valid && !is_callable('content_5ee886b07cdce3_32060870')) {
function content_5ee886b07cdce3_32060870 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->properties['nocache_hash'] = '1409169925ee886b07d4b71_24665891';
?>
<div class="head-top-static head-top-search js-head-top clearfix">
...
<span>普通用户</span></p>
        ...
        <div class="function-contain con_width">
            <div class="f-search-section clearfix">
                <div class="f-search-input js-search-box fl">
                    <div class="js-all-input-contain all-input-contain">
                        <input id="search_box2" class="input-Itext js-search-ipt" value="<?php echo $_smarty_tpl->tpl_vars['keyword']->value;?>
" data-staut="1" growing-track="true" placeholder="搜索你想要的" type="text" οnfοcus="this.placeholder=''" οnblur="this.placeholder='搜索你想要的'" autocomplete='off' />
                    ...
                    <div class="sea-col js-sea-color" style="top: 4px;" data-stu="1">
...
/*/%%SmartyNocache:1409169925ee886b07d4b71_24665891%%*/
}
}
?><?php
/*%%SmartyHeaderCode:11272336585ee886b088db33_73240341%%*/
if ($_valid && !is_callable('content_5ee886b088a7f0_16766410')) {
function content_5ee886b088a7f0_16766410 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->properties['nocache_hash'] = '11272336585ee886b088db33_73240341';
?>
<!-- 侧边导航 -->
...
<?php }?><?php
/*/%%SmartyNocache:11272336585ee886b088db33_73240341%%*/
}
}
?><?php
/*%%SmartyHeaderCode:3634192315ee886b08f3f48_61484821%%*/
if ($_valid && !is_callable('content_5ee886b08f1106_61808533')) {
function content_5ee886b08f1106_61808533 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->properties['nocache_hash'] = '3634192315ee886b08f3f48_61484821';
?>
...
/*/%%SmartyNocache:3634192315ee886b08f3f48_61484821%%*/
}
}
?><?php
/*%%SmartyHeaderCode:1240464745ee886b087c018_22118306%%*/
if ($_valid && !is_callable('content_5ee886b0877c50_19823091')) {
function content_5ee886b0877c50_19823091 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->properties['nocache_hash'] = '1240464745ee886b087c018_22118306';
?>
...
echo $_smarty_tpl->getInlineSubTemplate("common/nav_fixed_box.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, '11272336585ee886b088db33_73240341', 'content_5ee886b088a7f0_16766410');
...
echo $_smarty_tpl->getInlineSubTemplate("common/recommend-layer-box.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, '3634192315ee886b08f3f48_61484821', 'content_5ee886b08f1106_61808533');
/*  End of included template "common/recommend-layer-box.html" */?>


<?php
/*/%%SmartyNocache:1240464745ee886b087c018_22118306%%*/
}
}
?><?php
/*%%SmartyHeaderCode:9829143865ee886b09ece70_93459984%%*/
if ($_valid && !is_callable('content_5ee886b09e8fe2_75777248')) {
function content_5ee886b09e8fe2_75777248 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->properties['nocache_hash'] = '9829143865ee886b09ece70_93459984';
?>
...
>
    <?php }?>
<?php
/*/%%SmartyNocache:9829143865ee886b09ece70_93459984%%*/
}
}
?>