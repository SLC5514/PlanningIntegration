...
!function(g){
    ...
    Page.prototype.view = function() {
        ...
        function() {
            ...
            return conf.skip ? '<input type="text" min="1" value="' + conf.curr + '" class="layui-laypage-skip js-layui-laypage-skip"><button type="button" class="layui-laypage-btn" href="javascript:void(0);">跳转</button>': '';
        } () + '</div>';
    };
    ...
    Page.prototype.jump = function(elem) {
        ...
        if (btn) {
            ...
            function() {
                ...
                curr=curr-0<1?1:curr;
                curr=curr-0>conf.pages?conf.pages:curr;
                conf.curr=curr;
                that.render();
            });
        }
        ...
        if (input) {
            ...
            function(ev) {
                ...
                if(ev.keyCode==13){
                    val=val-0<1?1:val;
                    val=val-0>conf.pages?conf.pages:val;
                    conf.curr=val;
                    that.render();
                }
