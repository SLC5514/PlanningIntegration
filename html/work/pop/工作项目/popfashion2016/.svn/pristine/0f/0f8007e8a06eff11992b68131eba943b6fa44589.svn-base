 ...
 */
// 1:线上 2:测试环境 3或其他:开发环境
switch (getenv('BASEENV')) {
    case '1':
        $_env = 'production';
        break;
    case '2':
...
require_once $basepath . '/public/SsoMember.php';
require_once $basepath . '/config/config.php';
require_once $basepath .'/image_search/ImageSearch.php';//以图搜图
