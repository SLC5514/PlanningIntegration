$(function(){	
	...
	$('.js-season-sec').hover(function(){
		$('.js-rea-line').removeClass('rea-rotate');
	},function(){
		$('.js-rea-line').addClass('rea-rotate');
	});
	
	var season_timer = null;
	$('.js-season-sec>p').hover(function(){
		clearTimeout(season_timer);
		var _i = $(this).data('i')*1||0;
		var class_n = 'season-bg'+_i;
		season_timer = setTimeout(function(){
			$('.js-season1').removeClass('season-bg0').removeClass('season-bg1').removeClass('season-bg2').addClass(class_n);
		}, 200);
	},function(){
		clearTimeout(season_timer);
		season_timer = setTimeout(function(){
			$('.js-season1').removeClass('season-bg0').removeClass('season-bg1').removeClass('season-bg2');
		}, 200);
	});
	
	setTimeout(function(){
		$('.js-season1').addClass('animate1');
	}, 500);
	
	
	$('.js-season-sec>p').on('click', function(){
		var _i = $(this).data('i')*1||0;
		$('.js-season-item').eq(_i).fadeIn().addClass('animate2');
	});
	
	$('.js-sea-close').on('click', function(){
