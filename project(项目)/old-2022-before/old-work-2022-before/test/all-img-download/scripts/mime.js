...
window._w_dandy = new Array;

window._w_abuse = new Array;
...
for (let suffix in _w_skunk) {
    _w_abuse.push(suffix);
    _w_dandy.push(_w_skunk[suffix]);
}
...
window._w_smudge = [ "apng", "bmp", "gif", "ico", "jpg", "png", "svg", "tiff", "webp", "_" ];

window._w_egoism = [ "jpeg", "png", "apng", "bmp", "gif", "ico", "svg", "tiff", "webp", "apng" ];
